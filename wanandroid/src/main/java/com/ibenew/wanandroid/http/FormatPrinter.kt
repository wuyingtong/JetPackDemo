...
/**
 * Create by wuyt on 2019/12/19 14:13
 * {@link }
 */
interface FormatPrinter {
     ...
     */
    fun printJsonRequest(@NonNull request: Request?, @NonNull bodyString: String?)
    ...
    fun printJsonResponse(
        ...
        code: Int, @NonNull headers: String?, @Nullable contentType: MediaType?,
        @Nullable bodyString: String?, @NonNull segments: List<String?>?, @NonNull message: String?, @NonNull responseUrl: String?
    )
    ...
    fun printFileResponse(
        chainMs: Long,
        isSuccessful: Boolean,
        code: Int, @NonNull headers: String?,
        @NonNull segments: List<String?>?, @NonNull message: String?, @NonNull responseUrl: String?
    )
}